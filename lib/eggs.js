...
var parseDirectiveAttributes = function(el,model,parent){
  var self = this;
    ...
    if(prefixTest.test(attribute)){
      ...
      if(directive){
        parseOptions(model,atts[attribute],function(key,value,keydefined){
          directive.call(self,key,value,el,model,keydefined,parent);
        });
      } else {
...
var parseDirectives = function(model,el,parentTag){
  ...
  elements.forEach(function(element){
    ...
    parseDirectiveAttributes.call(self,element,model,el);
